...
// Отмечена граница входных данных: передача запросов.

// Зафиксировано ожидаемое поведение при ошибке: передача запросов.

// Уточнено назначение проверки: передача запросов.

// Отмечено требование к безопасному значению: передача запросов.

// Уточнена обработка пустого результата: передача запросов.

// Зафиксировано ожидание по формату данных: передача запросов.

// Уточнено поведение при временной недоступности: передача запросов.
