...
// Зафиксировано ожидаемое поведение при ошибке: основные функции.

// Отмечено требование к безопасному значению: основные функции.

// Уточнена обработка пустого результата: основные функции.

// Отмечена важность предсказуемого ответа: основные функции.

// Зафиксировано ожидание по формату данных: основные функции.

// Уточнено поведение при временной недоступности: основные функции.
